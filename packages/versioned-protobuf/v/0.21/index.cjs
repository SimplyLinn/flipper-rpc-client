  ...
  PB.Main = (function () {
    ...
    Main.verify = function verify(message) {
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.PingRequest.verify(
            message.systemPingRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.PingResponse.verify(
            message.systemPingResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.RebootRequest.verify(
            message.systemRebootRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.DeviceInfoRequest.verify(
            message.systemDeviceInfoRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.DeviceInfoResponse.verify(
            message.systemDeviceInfoResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.FactoryResetRequest.verify(
            message.systemFactoryResetRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.GetDateTimeRequest.verify(
            message.systemGetDatetimeRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.GetDateTimeResponse.verify(
            message.systemGetDatetimeResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.SetDateTimeRequest.verify(
            message.systemSetDatetimeRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.PlayAudiovisualAlertRequest.verify(
            message.systemPlayAudiovisualAlertRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.ProtobufVersionRequest.verify(
            message.systemProtobufVersionRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.ProtobufVersionResponse.verify(
            message.systemProtobufVersionResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.UpdateRequest.verify(
            message.systemUpdateRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.UpdateResponse.verify(
            message.systemUpdateResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.PowerInfoRequest.verify(
            message.systemPowerInfoRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_System.PowerInfoResponse.verify(
            message.systemPowerInfoResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.InfoRequest.verify(
            message.storageInfoRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.InfoResponse.verify(
            message.storageInfoResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.TimestampRequest.verify(
            message.storageTimestampRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.TimestampResponse.verify(
            message.storageTimestampResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.StatRequest.verify(
            message.storageStatRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.StatResponse.verify(
            message.storageStatResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.ListRequest.verify(
            message.storageListRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.ListResponse.verify(
            message.storageListResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.ReadRequest.verify(
            message.storageReadRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.ReadResponse.verify(
            message.storageReadResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.WriteRequest.verify(
            message.storageWriteRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.DeleteRequest.verify(
            message.storageDeleteRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.MkdirRequest.verify(
            message.storageMkdirRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.Md5sumRequest.verify(
            message.storageMd5sumRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.Md5sumResponse.verify(
            message.storageMd5sumResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.RenameRequest.verify(
            message.storageRenameRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.BackupCreateRequest.verify(
            message.storageBackupCreateRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Storage.BackupRestoreRequest.verify(
            message.storageBackupRestoreRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.LockStatusRequest.verify(
            message.appLockStatusRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.LockStatusResponse.verify(
            message.appLockStatusResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.AppExitRequest.verify(
            message.appExitRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.AppLoadFileRequest.verify(
            message.appLoadFileRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.AppButtonPressRequest.verify(
            message.appButtonPressRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.AppButtonReleaseRequest.verify(
            message.appButtonReleaseRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.GetErrorRequest.verify(
            message.appGetErrorRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.GetErrorResponse.verify(
            message.appGetErrorResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.DataExchangeRequest.verify(
            message.appDataExchangeRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gui.StartScreenStreamRequest.verify(
            message.guiStartScreenStreamRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gui.StopScreenStreamRequest.verify(
            message.guiStopScreenStreamRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gui.SendInputEventRequest.verify(
            message.guiSendInputEventRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gui.StartVirtualDisplayRequest.verify(
            message.guiStartVirtualDisplayRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gui.StopVirtualDisplayRequest.verify(
            message.guiStopVirtualDisplayRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gpio.SetInputPull.verify(
            message.gpioSetInputPull,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gpio.GetPinModeResponse.verify(
            message.gpioGetPinModeResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Gpio.ReadPinResponse.verify(
            message.gpioReadPinResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_App.AppStateResponse.verify(
            message.appStateResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Property.GetRequest.verify(
            message.propertyGetRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Property.GetResponse.verify(
            message.propertyGetResponse,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Desktop.IsLockedRequest.verify(
            message.desktopIsLockedRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Desktop.UnlockRequest.verify(
            message.desktopUnlockRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Desktop.StatusSubscribeRequest.verify(
            message.desktopStatusSubscribeRequest,
          );
      ...
      if (
        ...
        properties.content = 1;
        {
          var error = $root.PB_Desktop.StatusUnsubscribeRequest.verify(
            message.desktopStatusUnsubscribeRequest,
          );
